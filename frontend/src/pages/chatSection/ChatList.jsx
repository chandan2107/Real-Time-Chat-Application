    ...
    <div className={`w-full border-r h-screen ${theme==="dark"? "bg-[rgb(17,27,33)] border-gray-600" : "bg-white border-gray-200"}`}>
      ...
      <div className='p-2'>
        <div className='relative'>
          ...
          className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus: ring-green-500 ${theme==="dark"? "bg-gray-800 text-white border-gray-700 placeholder-gray-500" : "text-black bg-gray-100 placeholder-gray-500 border-gray-200"}`}
          value={searchTerms}
          ...
          className={`p-3 flex items-center cursor-pointer ${theme==="dark"? selectedContact?._id ===contact?._id ?"bg-gray-700":"hover:bg-gray-800" : selectedContact?._id ===contact?._id ?  "bg-gray-200":"hover:bg-gray-100"}`}>
            ...
            <div className='ml-3 flex-1'>
              ...
              <div className='flex justify-between items-baseline'>
                ...
                {contact?.conversation?.unreadCount > 0 && String(contact?.conversation?.lastMessage?.receiver) === String(user?._id) && (
